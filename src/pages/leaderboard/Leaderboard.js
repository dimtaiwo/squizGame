    ...
    useEffect(() => {
        fetch(`http://localhost:4000/scores`)
            ...
            .then(result => {
                ...
                sortedResults.map(result => console.log(`${result.username} points: ${result.points}`))
    ...
    return (
        <div className="Leaderboard container">
            ...
            <div className="scores">
                {filteredData.map((score, i) => <ScoreCard rank={i + 1} key={score._id} name={score.username} topic={score.topic} difficulty={score.difficulty} score={score.points} />)}
            </div>
